...
class ApiGateway {
  constructor(scope, id, props) {
    ...
    const lambdaIntegration1 = new apigateway.LambdaIntegration(props.getAllHomeDocs);
    const lambdaIntegration2 = new apigateway.LambdaIntegration(props.createHomeDoc);
