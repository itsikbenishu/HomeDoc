...
var require_withCors = __commonJS({
  "lambda/middlewares/withCors.js"(exports2, module2) {
    ...
    var allowedOrigins = [process.env.LOCAL_DOMAIN];
...
var require_homeDocModel = __commonJS({
  "lambda/models/homeDocModel.js"(exports2, module2) {
    ...
    var HomeDocs = pgTable("home_docs", {
    ...
    var HomeDocsRelations = pgTable("home_docs_relations", {
      id: serial().primaryKey(),
    ...
    module2.exports = {
      ...
      HomeDocsDimensions,
      HomeDocsRelations,
      ResidenceSpecsAttributes: ResidenceSpecsAttributes2,
      ChattelsSpecsAttributes: ChattelsSpecsAttributes2,
      CategoriesEnum,
      TypesEnum
    };
  }
...
exports.handler = withCors(async (event) => {
  try {
    ...
    specColumns = Object.keys(specsAttributes).filter(
